...
```
    ...
    ##   <int> <chr>                  <fct>         <dbl>
    ## 1  2010 AL - Jefferson County  Poor            5.5
    ## 2  2010 AL - Mobile County     Poor            6.4
    ## 3  2010 AL - Tuscaloosa County Poor            4.2
...
```
    ...
    ##    year location              response  data_value
    ##   <int> <chr>                 <fct>          <dbl>
    ## 1  2002 WV - Kanawha County   Excellent       16.5
    ## 2  2002 WI - Milwaukee County Excellent       21.1
    ## 3  2002 WY - Laramie County   Excellent       25.5
...
<img src="P8105_hw3_yc384_files/figure-gfm/unnamed-chunk-7-1.png" width="100%" />
